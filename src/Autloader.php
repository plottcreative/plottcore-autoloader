...
namespace Plott\Plottcore;

/**
 * Class Autoloader
 * @package Plott\Plottcore
 * @author Ashley Armstrong
 * @author Ewan Lockwood
 * @link https://www.plott.co.uk
 */
 ...
 class Autoloader
 {
        ...
        */
        ...
        {
            $cache = get_site_option('plottcore_autoloader');
        ...
        private function updateCache()
        {
            ...
            update_site_option('plottcore_autoloader', $this->cache);
        }
